...
# /tmp is the writable temporary directory on Vercel.
if os.environ.get("VERCEL") == "1":
    LOG_DIR = "/tmp/dataflow_logs"
else:
...
def setup_logger(
    name: str = "DataFlowAutomator",
    log_file: str = DEFAULT_LOG_FILE,
    level: int = logging.INFO
) -> logging.Logger:
    """
    Configures and returns a logger instance with
    console, file, and in-memory UI handlers.
    """
    ...
    if not logger.handlers:
        ...
        # Maximum 5MB per file, up to 5 backup files
